        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              <li class="nav-item active"><a class="nav-link" href="index.php">Домой</a></li>
              ...
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Клиенту</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="auth">Вход на сайт</a></li>
            ...
            <ul class="nav-shop">
              ...
              <li class="nav-item"><a class="button button-header" href="/auth">Вход на сайт</a></li>
            </ul>
          </div>
        </div>
      </nav>
